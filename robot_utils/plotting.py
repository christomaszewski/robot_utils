...
class DomainView(object):
	...
	def plot_vf(self, field, num_cells=(25,25), scale=0.05, pivot='mid', minshaft=1.5, ticks=None, clim=None, label_size=18, label_pad=16, show_colorbar=True, label_rotation=0, **kwargs):
		x_min, y_min, x_max, y_max = self._domain.bounds
		...
		if show_colorbar:
			...
			c.ax.tick_params(labelsize=label_size, labelrotation=label_rotation)
